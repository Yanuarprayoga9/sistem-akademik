      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <button type="button" class="btn btn-sm btn-outline-secondary"><a href="tambah.php">+ TAMBAH MAHASISWA</a></button>          </div>
        </div>
      </div>
            ...
            while($d = mysqli_fetch_array($data)){
              ...
              <tr scope="row">
                ...
                <td class="d-flex gap-2 text-light">
                  ...
                  <a href="hapus.php?id=<?php echo $d['npm']; ?>" class="btn btn-danger">HAPUS</a>
                </td>
              </tr>
              <?php 
            }
